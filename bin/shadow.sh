...
OUTFILE="$HOME/Pictures/Geektool/reflected.png"
# ===========================================================
...
$CONVERTER $workdir/daymonth.png -transparent black -background none -trim -rotate 90 $workdir/daymonth90.png
# stack the year on top of the rotated day/month and rotate the result -90 degrees
$CONVERTER $workdir/year.png $workdir/daymonth90.png -transparent black -gravity northeast -background none -append -rotate -90 $infile
